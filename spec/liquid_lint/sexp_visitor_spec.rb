...
describe LiquidLint::SexpVisitor do
  let(:visitor_class) do
    Class.new do
      include LiquidLint::SexpVisitor
      extend LiquidLint::SexpVisitor::DSL
    end
  end
  ...
  describe '#trigger_pattern_callbacks' do
    ...
    subject { visitor.trigger_pattern_callbacks(LiquidLint::Sexp.new(sexp)) }
