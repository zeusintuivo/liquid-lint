...
describe LiquidLint::Linter::RuboCop do
  ...
  before do
    ...
    LiquidLint::OffenseCollector.stub(:offenses)
  ...
  context 'when the LIQUID_LINT_RUBOCOP_CONF environment variable is specified' do
    around do |example|
      LiquidLint::Utils.with_environment 'LIQUID_LINT_RUBOCOP_CONF' => 'some-rubocop.yml' do
        example.run
      end
    end
